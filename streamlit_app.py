...
def llm_suggestion_handler(slack_id):
    ...
    # UI FIX: The spinner provides visual feedback so the user knows
    # the CPU is working and hasn't crashed.
    with st.spinner("🤖 CPU is processing the local model (Gemma)... This may take 10-20s."):
        try:
